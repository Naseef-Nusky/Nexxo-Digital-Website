    ...
    <main>
      ...
      <section className="px-5 py-20 md:px-8 md:py-28">
        <div className="mx-auto max-w-3xl space-y-6 text-lg leading-relaxed text-slate">
          ...
          <p className="font-display text-xl font-bold tracking-[0.12em] text-ink">
            BUILD. RANK. GROW.
          </p>
        </div>
      </section>
      ...
      <section className="border-y border-ink/10 bg-white px-5 py-20 md:px-8 md:py-28">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-8 space-y-6 text-lg leading-relaxed text-slate">
            ...
            <p className="font-medium text-ink">Our approach is simple:</p>
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-8 space-y-6 text-lg leading-relaxed text-white/75">
            ...
            <ul className="space-y-3">
              <li>How will customers discover your business?</li>
              <li>Why will they choose to visit your website?</li>
              <li>What will convince them to trust you?</li>
              <li>What will make them enquire or purchase?</li>
            </ul>
            <p className="font-medium text-white">And most importantly:</p>
            <p>How can we improve that process over time?</p>
            <p>
      ...
      <section className="px-5 py-20 md:px-8 md:py-28">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-12 max-w-3xl space-y-4 text-lg text-slate">
            <p>That’s what BUILD. RANK. GROW. means.</p>
            <p className="font-medium text-ink">
      ...
      <section className="border-y border-ink/10 bg-white px-5 py-20 md:px-8 md:py-28">
        <div className="mx-auto max-w-6xl">
          <SectionHeading title="Why Choose Nexxo Digital?" />
      ...
      <section className="px-5 py-20 md:px-8 md:py-28">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-8 space-y-6 text-lg leading-relaxed text-slate">
            ...
            <p>PPC generates immediate visibility.</p>
            <p>SEO develops long-term organic growth.</p>
            <p>Your website turns that traffic into enquiries and customers.</p>
            <p>
      ...
      <section className="bg-ink px-5 py-20 text-white md:px-8 md:py-28">
        <div className="mx-auto max-w-3xl">
          <SectionHeading light title="The Nexxo Standard" />
          <div className="mt-8 space-y-6 text-lg leading-relaxed text-white/75">
            <p>
              We want every client relationship to be built around four things:
            </p>
            <p className="font-display text-2xl font-bold text-white">
              Performance. Transparency. Communication. Growth.
            </p>
            <p>
